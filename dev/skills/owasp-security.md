---
description: "OWASP security review. Используй когда пользователь говорит 'security review', 'проверь безопасность', 'OWASP check', 'security audit', 'уязвимости', 'vulnerability check'. Прогоняет код по OWASP Top 10:2025 + ASVS 5.0. НЕ используй для: code review (senior-review), general review."
---
