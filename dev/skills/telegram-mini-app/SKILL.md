...
description: "Создание Telegram Mini Apps (TWA). Используй когда пользователь говорит 'Telegram Mini App', 'TWA', 'telegram web app', 'TON app', 'мини-приложение Telegram', 'WebApp API'. TON, оплата, аутентификация, вирусность. НЕ используй для: Telegram-ботов (telegram-bot-builder), обычных веб-приложений (frontend-design), стиля канала (l-w-style)."
