---
description: "Интерактивная проверка качества технического дизайна. Используй когда пользователь говорит 'validate design', 'проверь дизайн спеки', 'SDD design review', 'ревью архитектуры'. НЕ используй для: ревью кода (senior-review), валидации имплементации (sdd-validate-impl), gap-анализа (sdd-validate-gap)."
