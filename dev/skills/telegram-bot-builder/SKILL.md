...
description: "Создание Telegram-ботов: от простой автоматизации до AI-ботов. Используй когда пользователь говорит 'Telegram бот', 'bot API', 'tg bot', 'telegram automation', 'чат-бот Telegram', 'создай бота', 'Telegraf'. Архитектура, UX, монетизация, масштабирование. НЕ используй для: Telegram Mini Apps (telegram-mini-app), стиля канала (l-w-style, tg-style-master), email-ботов (email-systems), workflow (workflow-automation)."
