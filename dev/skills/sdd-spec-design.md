---
description: "Создание технического дизайна для SDD-спецификации. Используй когда пользователь говорит 'spec design', 'технический дизайн спеки', 'SDD design', 'архитектура спеки'. НЕ используй для: инициализации (sdd-spec-init), требований (sdd-spec-requirements), имплементации (sdd-spec-impl)."
