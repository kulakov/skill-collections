---
description: "Генерация задач имплементации для SDD-спецификации. Используй когда пользователь говорит 'spec tasks', 'задачи по спеке', 'SDD tasks', 'implementation plan'. НЕ используй для: инициализации (sdd-spec-init), дизайна (sdd-spec-design), имплементации (sdd-spec-impl)."
