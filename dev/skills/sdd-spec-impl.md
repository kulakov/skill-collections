---
description: "Выполнение задач спецификации по TDD-методологии. Используй когда пользователь говорит 'implement spec', 'имплементируй спеку', 'SDD implement', 'TDD implementation', 'code from spec'. НЕ используй для: генерации задач (sdd-spec-tasks), валидации (sdd-validate-impl), статуса (sdd-spec-status)."
