---
description: "Валидация имплементации против требований, дизайна и задач. Используй когда пользователь говорит 'validate implementation', 'проверь имплементацию', 'SDD validate', 'код соответствует спеке?'. НЕ используй для: ревью кода (senior-review), gap-анализа (sdd-validate-gap), валидации дизайна (sdd-validate-design)."
