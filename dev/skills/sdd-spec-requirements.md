---
description: "Генерация требований для SDD-спецификации. Используй когда пользователь говорит 'spec requirements', 'требования к спеке', 'SDD requirements', 'generate requirements'. НЕ используй для: инициализации (sdd-spec-init), дизайна (sdd-spec-design), задач (sdd-spec-tasks)."
