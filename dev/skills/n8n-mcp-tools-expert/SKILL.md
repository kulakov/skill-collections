...
description: "Эксперт по n8n-mcp MCP инструментам. Используй когда пользователь говорит 'n8n', 'n8n workflow', 'n8n MCP', 'n8n nodes', 'n8n template', 'n8n автоматизация'. Поиск нод, валидация конфигураций, шаблоны, управление workflow. НЕ используй для: Zapier/Make (zapier-make-patterns), workflow automation общий (workflow-automation), MCP-серверов (mcp-builder), Telegram-ботов (telegram-bot-builder)."
