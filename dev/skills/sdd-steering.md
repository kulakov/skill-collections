---
description: "Управление steering-файлами как persistent project knowledge. Используй когда пользователь говорит 'steering files', 'project knowledge', 'SDD steering', 'обнови steering'. НЕ используй для: спецификаций (sdd-spec-init), валидации (sdd-validate-design), статуса (sdd-spec-status)."
