---
description: "Статус и прогресс SDD-спецификации. Используй когда пользователь говорит 'spec status', 'прогресс спеки', 'SDD status', 'что сделано по спеке'. НЕ используй для: инициализации (sdd-spec-init), имплементации (sdd-spec-impl), валидации (sdd-validate-impl)."
