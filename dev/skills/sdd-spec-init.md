---
description: "Инициализация новой SDD-спецификации с описанием проекта. Используй когда пользователь говорит 'init spec', 'создай спецификацию', 'начни SDD', 'new specification', 'sdd init'. НЕ используй для: дизайна спеки (sdd-spec-design), генерации требований (sdd-spec-requirements), имплементации (sdd-spec-impl)."
