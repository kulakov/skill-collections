---
name: page-cro
description: "Оптимизация конверсии страниц (CRO). Используй когда пользователь говорит 'конверсия страницы', 'CRO', 'почему страница не конвертит', 'improve conversion rate', 'оптимизация лендинга', 'A/B тест', 'underperforming page'. Диагностика, приоритизация, тестируемые рекомендации. НЕ используй для: signup flow (signup-flow-cro), копирайтинга (copywriting), SEO (seo-fundamentals), создания лендинга (l-d-landing)."
